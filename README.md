...
```sh
 "C:\Program Files\SketchUp\SketchUp 2021\SketchUp.exe" -RubyStartupArg "TestUp:CI:Path: C:\Users\Petro\SourceTree\TestUp2\tests\TestUp UI Tests" > results.json
```

macOS:

```
'/Applications/SketchUp 2021/SketchUp.app/Contents/MacOS/sketchup' -RubyStartupArg 'TestUp:CI:Path: C:/Users/Petro/SourceTree/TestUp2/tests/TestUp UI Tests' > results.json
```
...
# Config.yml
# Required:
Path: C:\Users\Petro\SourceTree\TestUp2\tests\TestUp UI Tests
...
# file.
Output: C:\Users\Petro\SourceTree\TestUp2\tests\results.json

# Optional:
# Overriding where the .log files from a test run will be saved.
LogPath: C:\Users\Petro\SourceTree\TestUp2\logs

# Optional:
# Overriding where the .run files from a test run will be saved.
SavedRunsPath: C:\Users\Petro\SourceTree\TestUp2\logs
...
Given a configuration file located at `C:/Users/Petro/SourceTree/TestUp2/testup-ui-ci.yaml` then `%CONFIG_DIR%` will resolve to `C:/Users/Petro/SourceTree/TestUp2`.
